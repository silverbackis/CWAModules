<template>
  <div class="bw-starter-default layout">
              ...
              <div class="field is-grouped">
                ...
                <p class="control">
                  <a
                    ...
                    href="https://github.com/silverbackis/ComponentsWebApp"
                    rel="noopener"
                    target="_blank"
                  >
                    <span class="icon">
    ...
    <footer
      :class="{ footer: true, authorized: !!token, admin: $bwstarter.isAdmin }"
    >
      <div class="container has-text-centered has-text-weight-bold">
        <div v-if="!token">
          Try out the admin?&nbsp;&nbsp;<app-link
        ...
        <div v-else>
          You are logged in&nbsp;&nbsp;<a
            ...
            href="#"
            @click.prevent="$bwstarter.logout"
            >Logout</a
          >
        </div>
      </div>
